...
//    newGraph = this;
////    if(newGraph.vertices == this.vertices){
////    	System.out.println(true);
////    }
////    System.out.println(this.equals(newGraph));
//    UDGraph tmpGraph = new UDGraph(vertices);
////    tmpGraph.edges = newGraph.edges;
////    tmpGraph.adjMatrix = newGraph.adjMatrix;
//    for(int i = 0; i < newGraph.vertices; i++){
//    	for(int j = 0; j < newGraph.vertices; j++){
//    		if(newGraph.hasEdge(i, j)){
//    			for(int k = 0; k < newGraph.vertices; k++){
//    				if(newGraph.hasEdge(j, k)){
//    					tmpGraph.addEdge(i, k);
//    				}
//    			}
//    		}
//    	}
//    }
//    newGraph.edges = tmpGraph.edges;
//    newGraph.adjMatrix = tmpGraph.adjMatrix;
  ...
  public UDGraph paths(int length) {
    ...
    if(length == 2){
    	return this.length2Paths();
    }
    else{
    	UDGraph newer = this.paths(length - 1);
    	for(int i = 0; i < this.vertices; i++){
    		for(int j = 0; j < this.vertices; j++){
    			if(newer.hasEdge(i, j)){
    				for(int k = 0; k < this.vertices; k++){
    					if(this.hasEdge(j, k)){
    						newGraph.addEdge(i, k);
    					}
