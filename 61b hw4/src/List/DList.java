...
package List;
//part2 DListNode node 作为参数不会成为part of DList instance???
/**
...
public class DList {
   ...
   */
  public DList() {//为什么不能head=newNode(0,head,head)呢？？？
    //  Your solution here.
  ...
  public static void main(String[] args){
	  ...
	  DListNode second =D.next(D.front());
	  
	  System.out.println(second.item);
	  D.insertBefore("hello", second);
	  D.insertAfter("bye", second);
	  System.out.println(D);
	  System.out.println(D.length());
